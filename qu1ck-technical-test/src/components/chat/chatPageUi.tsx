...
export function ChatPageUi(props: chatPageUiProps) {
  ...
  return (
    <div className="flex flex-col h-screen bg-white">
      ...
      <div className="bg-white border-t border-gray-200 p-4 flex items-center fixed bottom-1 w-full">
        <input
          type="text"
          placeholder="Escreva a sua mensagem..."
          className="flex-1 rounded-lg bg-gray-100 border-none focus:ring-0 focus:border-none pl-2 py-2 mr-2"
          ref={inputRef}
          onKeyDown={(key) => {
